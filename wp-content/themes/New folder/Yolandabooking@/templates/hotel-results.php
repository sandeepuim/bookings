...
// Include the TBO API Client
$tboApiClientPath = dirname(__FILE__) . '/../inc/SimpleTboApiClient.php';
if (!file_exists($tboApiClientPath)) {
    wp_die('Error: SimpleTboApiClient.php not found. Please check if the file exists in the inc directory.');
}
require_once $tboApiClientPath;

if (!class_exists('SimpleTboApiClient')) {
    wp_die('Error: SimpleTboApiClient class not found after including the file.');
}
