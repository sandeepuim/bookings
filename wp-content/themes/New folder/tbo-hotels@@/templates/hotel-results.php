...
jQuery(document).ready(function($) {
            ...
            <div class="yatra-hotel-card" data-hotel-code="${hotel.HotelCode}">
                ...
                <div class="hotel-pricing-section">
                    ...
                    <div>
                        ...
                        <button style="background: #ff6b35; color: white; border: none; padding: 12px 24px; border-radius: 6px; font-size: 14px; font-weight: 600; cursor: pointer; width: 100%;" class="btn-choose-room" data-hotel-code="${hotel.HotelCode}">
                            Choose Room
                        </button>
                    </div>
                </div>
    ...
    /**
     * Handle Choose Room button click
     */
    $(document).on('click', '.btn-choose-room', function() {
        const hotelCode = $(this).data('hotel-code');
        
        // Redirect to hotel rooms page with parameters
        window.location.href = '/bookings/hotel-rooms/?hotel_code=' + hotelCode + 
