            ...
            <div class="yatra-hotel-card" data-hotel-code="${hotel.HotelCode}">
                ...
                <div class="hotel-pricing-section">
                    ...
                    <div>
                        ...
                        <button class="choose-room-btn" style="background: #ff6b35; color: white; border: none; padding: 12px 24px; border-radius: 6px; font-size: 14px; font-weight: 600; cursor: pointer; width: 100%;">
                            Choose Room
                        </button>
                    </div>
                </div>
